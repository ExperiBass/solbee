        ...
        if (fileExists) {
            ...
            try {
                ...
                try {
                    ...
                    log(`Couldn't write to 'solbee.json', reverting to default configuration`, 'WARNING')
                    return false
                }
            } catch (e) {
            ...
            try {
                ...
                log(`Sucessfully created config file in ${path.join(__dirname, projectPath)}!`, 'INFO')
            } catch (e) {
